		...
		<el-collapse accordion>
			...
			<template v-if="main.vaildProp('titleList')">
				<el-collapse-item title="标题设置">
					...
					<el-form-item label="字体位置">
						<avue-select v-model="main.activeOption.titlePostion" :dic="dicOption.textAlign"> </avue-select>
					</el-form-item>
					...
					<el-form-item label="字体大小">
						<avue-input-number v-model="main.activeOption.subTitleFontSize"> </avue-input-number>
					</el-form-item>
				</el-collapse-item>
			</template>
			<!-- 轴设置 -->
			<template v-if="main.vaildProp('barList')">
				<el-collapse-item title="X轴设置">
					<el-form-item label="显示轴线">
						<avue-switch v-model="main.activeOption.xAxisAxisLineShow"> </avue-switch>
					</el-form-item>
					<el-form-item label="显示轴刻度">
						<avue-switch v-model="main.activeOption.xAxisAxisTickShow"> </avue-switch>
					</el-form-item>
					...
					<el-form-item label="显示网格线">
						<avue-switch v-model="main.activeOption.xAxisSplitLineShow"> </avue-switch>
					</el-form-item>
					<el-form-item label="标签与轴线间距">
						<avue-input-number v-model="main.activeOption.xAxisMargin"> </avue-input-number>
					</el-form-item>
					<el-form-item label="标签间距">
						<avue-switch v-model="main.activeOption.xAxisinterval"> </avue-switch>
					</el-form-item>
					<el-form-item label="文字角度">
						<avue-input-number v-model="main.activeOption.xAxisRotate"> </avue-input-number>
					</el-form-item>
					<el-form-item label="轴反转">
						<avue-switch v-model="main.activeOption.xAxisInverse"> </avue-switch>
					</el-form-item>
					<el-form-item label="字号">
						<avue-input-number v-model="main.activeOption.xNameFontSize"> </avue-input-number>
					</el-form-item>
				</el-collapse-item>
				<el-collapse-item title="Y轴设置">
					...
					<el-form-item label="显示轴线">
						<avue-switch v-model="main.activeOption.yAxisAxisLineShow"> </avue-switch>
					</el-form-item>
					<el-form-item label="显示轴刻度">
						<avue-switch v-model="main.activeOption.yAxisAxisTickShow"> </avue-switch>
					</el-form-item>
					<el-form-item label="轴网格线">
						<avue-switch v-model="main.activeOption.yAxisSplitLineShow"> </avue-switch>
					</el-form-item>
					<el-form-item label="反转">
						<avue-switch v-model="main.activeOption.yAxisInverse"> </avue-switch>
					</el-form-item>
					<el-form-item label="字号">
						<avue-input-number v-model="main.activeOption.yNameFontSize"> </avue-input-number>
					</el-form-item>
				</el-collapse-item>
			</template>
			<!-- 数值设置 -->
			<template v-if="main.vaildProp('labelList')">
				<el-collapse-item title="数值设置">
					...
					<el-form-item label="字体大小">
						<avue-input-number v-model="main.activeOption.labelShowFontSize"> </avue-input-number>
					</el-form-item>
					<el-form-item label="字体颜色">
						<avue-input-color v-model="main.activeOption.labelShowColor"> </avue-input-color>
					</el-form-item>
					<el-form-item label="字体粗细">
						<avue-select v-model="main.activeOption.labelShowFontWeight" :dic="dicOption.fontWeight"> </avue-select>
					</el-form-item>
				</el-collapse-item>
			</template>
			<!-- 提示语设置  -->
			...
			<template v-if="main.vaildProp('legendList')">
				<el-collapse-item title="图例操作">
					...
					<el-form-item label="位置">
						<avue-select v-model="main.activeOption.legendPostion" :dic="dicOption.textAlign"> </avue-select>
					</el-form-item>
					<el-form-item label="布局朝向">
						<avue-select v-model="main.activeOption.legendOrient" :dic="dicOption.orientList"> </avue-select>
					</el-form-item>
					<el-form-item label="字体大小">
						<avue-input-number v-model="main.activeOption.legendFontSize"> </avue-input-number>
					</el-form-item>
				</el-collapse-item>
			</template>
			<!-- 颜色设置 -->
